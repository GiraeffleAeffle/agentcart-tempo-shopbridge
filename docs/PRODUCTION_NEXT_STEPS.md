...
7. **Production beta**: refunds, tracking, idempotency, replay protection,
   admin readiness checks, and the P0 pilot checklist are tested against real
...
validated by `scripts/check-pilot-readiness.py`.
