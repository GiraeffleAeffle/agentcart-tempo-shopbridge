...
| --- | --- |
| Product | `product_id`, `sku`, `title`, `description`, `category`, `brand`, `unit_size`, `image_urls`, `price_cents`, `currency`, `stock`, `availability`, `shipping_regions` |
| Quote | `items`, `subtotal_cents`, `shipping`, `vat_lines`, `total_cents`, `currency`, `delivery_window`, `merchant_of_record`, `quote_hash`, `expires_at`, `payment_requirements` |
