...
`values.pilot.yaml` contains only public and historical records generated by
the active USD testnet merchant. The EUR compatibility entry is deliberately
excluded until Tempo supports an appropriate EUR settlement asset. This is a
reproducible demo overlay, not a Secret or a template for private cluster
topology.
