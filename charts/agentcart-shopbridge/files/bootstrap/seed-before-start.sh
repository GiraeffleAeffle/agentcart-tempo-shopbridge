...
set_raw DISABLE_WP_CRON "${AGENTCART_EXTERNAL_SCHEDULER:-false}"
set_raw AGENTCART_EXTERNAL_SCHEDULER "${AGENTCART_EXTERNAL_SCHEDULER:-false}"
...
set_string AGENTCART_REGISTRY_ONCHAIN_CONTROLLER "${AGENTCART_REGISTRY_ONCHAIN_CONTROLLER:-}"
