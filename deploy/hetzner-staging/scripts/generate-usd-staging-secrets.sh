...
signed_request_mode="${AGENTCART_SIGNED_REQUEST_MODE:-require_checkout}"
signed_request_secret="${AGENTCART_SIGNED_REQUEST_SECRET:-$(random_hex 32)}"
...

{
  ...
  write_env_var STAGING_SIGNED_REQUEST_MODE "$signed_request_mode"
  write_env_var STAGING_SIGNED_REQUEST_SECRET "$signed_request_secret"
